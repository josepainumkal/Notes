...
rented_hostips.append('http://10.0.9.4:2375')
...
def create_model_run():
    ...
    token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZGVudGl0eSI6MSwiaWF0IjoxNDgzODIwOTI1LCJuYmYiOjE0ODM4MjA5MjUsImV4cCI6MTQ4NDY4NDkyNX0.3Q9b9mRFg7u-Nr2j5o7Yk0G5CkQnjadp2jPiaZbjt2s'
    payload = {'description': 'test_description', 'model_name': 'prms', 'title': 'test01'}
    headers={'Content-Type':'application/json', 'Authorization': 'JWT %s' % token}
